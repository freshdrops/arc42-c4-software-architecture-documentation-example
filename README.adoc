...
[source, bash]
----
docker run -it --rm -v $PWD:/usr/local/structurizr structurizr/cli export -w documentation/model.dsl -format plantuml/structurizr -output documentation/diagrams
----
...
[source, bash]
----
./bin/structurizr-cli/structurizr.sh export -w documentation/model.dsl -format plantuml/structurizr -output documentation/diagrams
----
